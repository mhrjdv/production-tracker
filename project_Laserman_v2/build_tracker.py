#!/usr/bin/env python3
"""Build Laserman production tracker HTML with embedded JSON data."""
...
def main():
    ...
    characters = load_json('laserman_v2_characters.json')
    scenes_extracted = load_json('laserman_v2_scenes_extracted.json')
    scenes_description = load_json('laserman_v2_scenes_description.json')
...
<head>
  ...
  <title>Laserman Film — Production Tracker</title>
...
<body>
  ...
  <div class="app">
    <header>
      <div>
        <h1>Laserman Film — Production Tracker</h1>
  ...
  <script>
    ...
    const STORAGE_KEY = 'laserman_production_tracker';
    const KEYFRAMES_KEY = 'laserman_keyframes';

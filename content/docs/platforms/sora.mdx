...
When you generate on Sora, Laserman extracts:
...
6. Open Laserman extension side panel
...
- Laserman fetches and stores immediately
...
A typical Sora capture in Laserman:

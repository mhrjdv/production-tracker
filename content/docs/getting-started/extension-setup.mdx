...
description: Install and connect the Lazer Chrome extension for capturing AI-generated assets.
---
...
- You have completed [Installation](/docs/getting-started/installation) and the Lazer web app is running
...
- Report bugs on [GitHub Issues](https://github.com/yourusername/lazer/issues)

For feature requests or workflow suggestions, join the discussion on [GitHub Discussions](https://github.com/yourusername/lazer/discussions).

...
Enter the URL of your Laserman instance. The field starts empty — you **must** configure this explicitly:
...
2. Send the payload to the Laserman API (`POST /api/extension/ingest`)

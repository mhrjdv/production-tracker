...
You've completed the Core Concepts section. For hands-on guidance, see the [Getting Started](/docs/getting-started) guide to begin using Lazer in your production workflow.

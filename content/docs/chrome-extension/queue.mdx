...
5. Attempts to sync to Laserman API
...
- Successfully uploaded to Laserman API
...
**Cause:** Laserman API encountered an error
...
**Cause:** No internet connection or Laserman API unreachable

**Fix:**
1. Verify your internet connection
2. Verify Laserman instance is running

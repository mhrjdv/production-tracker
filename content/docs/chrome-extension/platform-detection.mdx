...
The Laserman extension uses modular platform detectors to extract prompts, generation settings, and output URLs from AI platform pages. Each detector is tailored to the specific DOM structure and UI patterns of one platform.
...
- Laserman should fetch and store the media immediately

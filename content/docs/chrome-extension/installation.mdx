...
The Laserman Chrome Extension is currently distributed as an unpacked extension for development and testing. Follow these steps to load and configure it.

## Prerequisites

- Chrome, Edge, or Brave browser (Manifest V3 support)
- Laserman account (sign up at your Laserman instance)
- API token (generated from your Laserman account)

## Step 1: Obtain the Extension

Clone or download the Laserman project repository:

```bash
git clone https://github.com/your-org/laserman-v2.git
cd laserman-v2/chrome-extension
```
...
4. Select the `chrome-extension` directory from the Laserman project
...
Before you can use the extension, you need to create an API token in your Laserman account:

1. Log in to your Laserman web app
...
- Check that the App URL matches your Laserman instance exactly (including http/https and port)
...
- Verify your Laserman instance is running and accessible
...
3. Click the refresh icon on the Laserman extension card

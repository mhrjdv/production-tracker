...
The Laserman Extension API is a REST API that enables the Chrome extension to sync captured assets to your Laserman workspace. It provides endpoints for listing projects and scenes, submitting captured assets, and managing user profile preferences.
...
The base URL depends on your Laserman deployment:

- **Development:** `http://localhost:3000`
- **Production:** `https://laserman.yourdomain.com`
...
```http
Authorization: Bearer lmt_1234567890abcdef...
```
